...
void exercise2() {
    ...
    assert(arr2.get(0) == 99);  // Copy modified
...
void exercise5() {
    ...
    {
        SmallObj stack_objs[N];  // VLA-like, may need compiler extension
    ...
    std::cout << "Stack allocation: " << stack_time / 1000.0 << " μs\n";
    std::cout << "Heap allocation:  " << heap_time / 1000.0 << " μs\n";
