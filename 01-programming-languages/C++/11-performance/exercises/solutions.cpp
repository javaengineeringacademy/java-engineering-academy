...
void benchmark_vector_operations() {
    ...
    // Vector insert at front (expensive)
    timer.start();
    std::vector<int> vec2;
...
// ============================================================================
// Exercise 7 Solution: Benchmark Utility
// ============================================================================

// Timer class already defined above
...
void hot_loop_optimized(const std::vector<int> &data, long long &sum) {
    sum = 0;
    for (int val : data) {
        sum += val & ~1;  // Clear LSB (effectively sum even numbers)
    }
}
