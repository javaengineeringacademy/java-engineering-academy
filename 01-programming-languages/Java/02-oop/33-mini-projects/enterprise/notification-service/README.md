...
classDiagram
    class Notification {
        ...
        -int retryCount
        -String errorMessage
        +Notification(id, recipientId, channel, content)
        +getNotificationId() String
        +getStatus() DeliveryStatus
        +updateStatus(DeliveryStatus) void
        +incrementRetry() void
    }
    ...
    class NotificationRequest {
        ...
        +NotificationRequest(recipientId, templateId, data)
    ...
    class Template {
        ...
        -String name
        -NotificationType type
        -Map~NotificationChannel,String~ contentTemplates
        -Map~NotificationChannel,String~ subjectTemplates
        -boolean isActive
        +Template(id, name, type)
        +getTemplateId() String
        +getContent(NotificationChannel) String
        +getSubject(NotificationChannel) String
        +render(NotificationChannel, Map~String,Object~) RenderedContent
    }
    ...
    class DeliveryStatus {
        ...
        -String errorMessage
        +DeliveryStatus(notificationId, channel, status)
        +getStatus() Status
    ...
    class UserPreferences {
        ...
        +isTypeEnabled(NotificationType) boolean
        +isQuietHours(LocalDateTime) boolean
        +setChannelPreference(NotificationChannel, boolean) void
    }
    ...
    class TemplateEngine {
        <<interface>>
        +render(String template, Map~String,Object~ data) String
    }
    ...
    class NotificationService {
        ...
        +getNotificationStatus(String) DeliveryStatus
        +cancelNotification(String) boolean
    }
    ...
    class DeliveryService {
        ...
        +retryDelivery(Notification) DeliveryResult
        +getStrategy(NotificationChannel) DeliveryStrategy
    }
    ...
    class RetryHandler {
        ...
        +getNextRetryDelay(int) long
        +executeWithRetry(Callable~T~, Notification) T
    }
