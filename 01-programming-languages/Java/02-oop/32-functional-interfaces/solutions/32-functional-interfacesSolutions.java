package academy.javaengineering.oop.solutions;

/**
 * Solutions to practice exercises for 32-functional-interfaces.
 * Use this only after attempting the exercises.
 */
public class Solutions {

    public static void main(String[] args) {
        System.out.println("=== Solutions: 32-functional-interfaces ===\n");
