package academy.javaengineering.reflection.realworld.solutions;

import java.lang.annotation.*;
import java.lang.reflect.*;
import java.util.*;

public class Solution2_MiniValidator {
        ...
        for (Field field : obj.getClass().getDeclaredFields()) {
            ...
            if (minLen != null && value instanceof String) {
                if (((String) value).length() < minLen.value()) {
                    errors.add(field.getName() + " must be at least " + minLen.value());
                }
            }
        }
        return errors;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(validate(new User("", "ab")));
        System.out.println(validate(new User("Alice", "secret")));
    }
}
