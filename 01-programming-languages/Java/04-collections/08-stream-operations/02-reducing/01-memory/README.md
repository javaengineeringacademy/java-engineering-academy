# Reducing Operations Memory Usage

## Per-Operation Overhead

```
Reducing operation creates:
...
```java
list.stream()
    .reduce(...)  // +48 bytes (stream + pipeline)
...
|------------|-----------------|-------------|-------|
| 100 items | 48 bytes | ~16 bytes | ~64 bytes |
| 1,000 items | 48 bytes | ~16 bytes | ~64 bytes |
| 10,000 items | 48 bytes | ~16 bytes | ~64 bytes |
