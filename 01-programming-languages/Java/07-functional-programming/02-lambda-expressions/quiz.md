# LambdaExpressions Quiz

## Multiple Choice Questions

1. What is the primary purpose of LambdaExpressions?
   - A) Object creation
   - B) Memory management
   - C) Code reusability and abstraction
   - D) Thread synchronization

2. Which of the following is true about LambdaExpressions?
...
5. Which Java version introduced LambdaExpressions?
   - A) Java 7
   - B) Java 8
   - C) Java 9
   - D) Java 11
...
1. LambdaExpressions can only be used with streams. (T/F)
2. LambdaExpressions supports side effects by design. (T/F)
3. LambdaExpressions promotes immutability. (T/F)
