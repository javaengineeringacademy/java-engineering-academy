...
1. What is the primary purpose of Optional?
   - A) Object creation
   - B) Memory management
   - C) Code reusability and abstraction
   - D) Thread synchronization

2. Which of the following is true about Optional?
...
5. Which Java version introduced Optional?
   - A) Java 7
   - B) Java 8
   - C) Java 9
   - D) Java 11
...
1. Optional can only be used with streams. (T/F)
2. Optional supports side effects by design. (T/F)
3. Optional promotes immutability. (T/F)
