package academy.javaengineering.io.solutions;

public class Solutions {
    public static void main(String[] args) {
        System.out.println("=== Solution: 04-character-streams ===\n");
        ...
        System.out.println("- File I/O operations with 04-character-streams");
