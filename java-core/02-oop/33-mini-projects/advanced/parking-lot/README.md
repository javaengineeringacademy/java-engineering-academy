...
graph TB
    ...
    subgraph Service Layer
        PS[ParkingService.java]
        VS[VehicleService.java]
    ...
    subgraph Pattern Layer
        ...
        State[TicketState.java]
    end
    
    subgraph Model Layer
        V[Vehicle.java]
        PS2[ParkingSpot.java]
        T[Ticket.java]
        PL[ParkingLot.java]
    end
...
classDiagram
    ...
    class Ticket {
        ...
        +updateStatus(TicketStatus) void
    }
    ...
    class ParkingLot {
        ...
        +ParkingLot(id, name, floors)
        +addFloor(SpotType, int) void
    ...
    class VehicleFactory {
        +createVehicle(String, String, VehicleType) Vehicle
    }
...
- [Factory Pattern](https://www.baeldung.com/java-factory-pattern)
