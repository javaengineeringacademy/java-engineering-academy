...
⚠️ **Integer Division**: `10 / 3 = 3` not `3.333`. Use `10.0 / 3` for decimals.
...
| **Methods** | Pass-by-value, overload for convenience, recurse with base case |
...
6. **When to use StringBuilder vs String?** → Building/modifying vs constant strings
7. **What is the output of `10 / 3`?** → `3` (integer division)
8. **How does switch expression differ from statement?** → Returns value, no fall-through, exhaustive