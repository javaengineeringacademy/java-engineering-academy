...
class ForLoopTest {
    ...
    void testLabeledBreak() {
        ...
        assertEquals(4, count);  // (1,1)(1,2)(1,3)(2,1)
    }
    ...
    void testLabeledContinue() {
        ...
        assertEquals(3, count);  // (1,1)(2,1)(3,1)
    }
}
...
class WhileDoWhileTest {
    ...
    void testDoWhileRunsOnce() {
        ...
        assertEquals(1, count);  // Runs at least once
    }
